...
data class DayDto(
    ...
    @SerializedName("totalprecip_mm") var totalPrecip: Double? = null,
...
data class HourDto(
    ...
    @SerializedName("pressure_mb") var pressure: Double? = null,
    @SerializedName("precip_mm") var precip: Double? = null,
